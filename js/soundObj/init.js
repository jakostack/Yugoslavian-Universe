...
var disclosure_whiteNoise = {
	
	file:"disclosure_whiteNoise.mp3",
	img:"img/galaxies/europe/britain/england/disclosure_whiteNoise.png",
	info:"Disclosure are a British electronic band. The duo consists of brothers Guy (b. 1991) and Howard (b. 1994) Lawrence. The siblings grew up in Reigate, Surrey They supported SBTRKT and Hot Chip on their recent 2012 tours.<br/><br/> From <a href='http://en.wikipedia.org/wiki/Disclosure_(band)' target='_blank'>Wikipedia</a>",
    color:0xff0000,

    //The Planets for this solar system
	planets:{
		numOf:50,
		type:planetLib.type.sphere(2000,10,10),
		dataType: planetLib.type.sphere(2000,10,10),
	...
	suns:{
		numOf:10,
		type:planetLib.type.icosahedron(300,1),
		dataType:planetLib.type.icosahedron(300,1),
		material:planetLib.material.colorNormal(0x994400),
    ...
    dust:{
		pNum:20,
		fNum:20,
		pPosition: dustLib.pPosition.ringX(40,20),
		pMaterial: dustLib.pMaterial.imgAdditive("img/bwe.png",10,.1,.8,.9),
...
var andyStott_luxuryProblems= {
	
	file:"andyStott_luxuryProblems.mp3",
	img:"img/galaxies/europe/britain/england/andyStott_luxuryProblems.png",
	info:"Andy Stott is a Manchester-based producer of dub and techno music who has released three albums with the Modern Love label. His debut album was Merciless in 2006, and was followed by Unknown Exception (2008) and Luxury Problems in 2012.a href='http://en.wikipedia.org/wiki/Andy_Stott' target='_blank'>Wikipedia</a>",
	
	links:[
        ["Modern Love","http://www.modern-love.co.uk/artists/andy-stott"],
		["Facebook","https://www.facebook.com/pages/Andy-Stott/262174253793725"]
    ],	
...
var england ={
		...
		children:[
			...
			hotflush,
			brownswood,
            disclosure_whiteNoise,
            andyStott_luxuryProblems
...
var jacquesGreene_anotherGirl={
	file:"jacquesGreene_anotherGirl.mp3",
	img:"img/galaxies/europe/britain/scotland/jacquesGreene_anotherGirl.png",
...
var crispoa_dancingCurtains = {
	...
	title:"Crisopa - Dancing Curtains",
...
var ametsub_snowyLava={
	...
	img:"img/galaxies/europe/germany/ametsub_nothingsOfTheNorth_large.jpg",
...
var vladislavDelay_vastaa = {
	...
	img:"img/galaxies/europe/scandinavia/vladislavDelay_kuopio.png",
...
var theKnife_likeAPen={
	...
	img:"img/galaxies/europe/scandinavia/theKnife_silentShout.png",
...
var theField_loopingStateOfMind ={
	...
	img:"img/galaxies/europe/scandinavia/theField_loopingStateOfMind.png",
	info:"Axel Willner is a Swedish electronic music producer and DJ from Stockholm and currently based in Berlin, best known for his critically acclaimed releases as The Field that blend micro-samples of traditional pop songs into his unique brand of atmospheric minimal techno.<br/><br/>From <a href='http://en.wikipedia.org/wiki/The_Field_(musician)' target='_blank'>Wikipedia</a>",
	links:[
...
var scandinavia ={
	...
	title:"Scandinavia",
	img:"img/galaxies/europe/scandinavia/scandinavia.png",
...
*/
		...
		var xei={
			img:"img/galaxies/laGalaxy/xei.png",
			file:"xei_oLard.mp3",
			title:"Xei The Ghost - O Lard",
			links:[
				['Xei','http://elsupermusiccollective.com/xei.html'],
			]	
			
		}
		
		var cozy ={
			img:"img/galaxies/laGalaxy/laSupra.png",
			file:"cozy_theDreamU.mp3",
			links:[
				['Cozy','http://elsupermusiccollective.com/cozy.html'],
			]	
		}
		
		var cozy_urSure ={
			img:"img/galaxies/laGalaxy/cozy_urSure.png",
			file:"cozy_ghost.mp3",
            title:"Cozy - Ghost",
			links:[
				['Cozy','http://elsupermusiccollective.com/cozy.html'],
		...
		var pno ={
			img:"img/galaxies/laGalaxy/pno.png",
			file:"pno_crystalChandelier.mp3",
			title:"Pink Noise Ordinance - Crystal Chandelier",
			links:[
				['PNO','http://elsupermusiccollective.com/pno.html'],
			]	
			
		}
		
		var supaApe={
			img:"img/galaxies/laGalaxy/supaApe.png",
			file:"supaApe_buttLunch.mp3",
			links:[
				['Charles Melvin','http://elsupermusiccollective.com/charles.html'],
			]
			
		}
		
		var chazz_jesusSlice={
			img:"img/galaxies/laGalaxy/chazz_jesusSlice.png",
			file:"chazz_jesusSlice.mp3",
			title:"Chazz Shabazz - Jesus Slice",
			links:[
				['Charles Melvin','http://elsupermusiccollective.com/charles.html'],
			]	
		...
		var esmk={
			img:"img/galaxies/laGalaxy/riceCake.png",
			file:"esmk_esMilitiaKilla.mp3", 
			theme:'egg',
			...
			links:[
				['Music: ESMK - ES Militia Killa','http://elsupermusiccollective.com/'],
			]	
		...
		//Important! Somereason the next galaxy ?
		var hitRun = {
			
			
			title:"Max & Intro - Beogradska Devojka",
			img:"img/galaxies/laGalaxy/hitRun/clusterLogo.png",
			file:"Max & Intro - Beogradska Devojka.mp3",
			info: "",
			links:[
	...
	var la = {
				id:"laGalaxy",
				title:"SAMA - VIA TALAS",
				info:"This one's for you Martin.",
				file:"SAMA - VIA TALAS.mp3",
...
secretCircuit_afterlife = {
	...
	file:"secretCircuit_afterlife.mp3",
...
var shangaan_Electro={
	...
	img:"img/galaxies/africa/shangaanElectro.png",
...
MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN MAIN 
...
var northAmerica={
	...
	file:"Zana - Dodirni mi kolena.mp3",
	img:"img/4c5bf2.png",
	title:"Zana - Dodirni mi kolena",
...
var southAmerica = {
	file:"Zdenka Kovačiček - Voli me još danas (La Cicala).mp3",
	img:"img/4c5bf2.png",
	title:"South Zdenka Kovačiček - Voli me još danas (La Cicala)",
	links:[
...
var secretVerse = {
			file:"cabbibo_silenceLikeALanguage.mp3",
			info:"I soak it all in, you know.",
			img:"img/silenceLikeALanguage.png",
			links:[
...
var uOS = {
				...
				info:"You're far out now. Keep playing so you'll get home.",
				title:"Miha Kralj - Pegaz",
				file:"Miha Kralj - Pegaz.mp3",
				img:"img/cabLogo.png",
				links:[
				...
				planets:{
					...
					material:planetLib.material.colorNormal(0x01505C),

THREE.MomentumControls = function ( object, domElement ) {
	...
	/*
		CABBIBO ADDED
		just to make it so that the camera has momentum
	...
	*/
	...
	//deceleration is a /deceleration function,
	//this is so that the camera accelerates quickly, 
	//but also decelerates quickly, especially at very high speeds
	this.acceleration = 100
	this.deceleration = 1.03
	...
	this.update = function ( delta ) {
		...
		*/
		...
		if(mouseIsDown == true){
			...
			if(this.movementSpeed > this.acceleration){

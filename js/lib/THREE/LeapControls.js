...
//adding This variable, so as soon as the user puts their hand in the scene,
//it will start the scene animating
var LeapUniverseStart = false
	...
	Leap.loop(function(frame) {
      ...
      if(frame.hands){
        if(frame.hands[0]){
            ...
            if(LeapUniverseStart == false && universeCanStart == true){
            
              startUniverse();
              LeapUniverseStart = true
            }
